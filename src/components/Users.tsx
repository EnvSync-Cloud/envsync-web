              ...
              <tbody>
                {users.map((user) => (
                  <tr key={user.id} className="border-b border-gray-700 hover:bg-gray-750">
                    ...
                    <td className="py-4 px-4">
                      <span className="text-sm text-gray-300">{user.access}</span>
                    </td>
                    <td className="py-4 px-4">
                    ...
                    <td className="py-4 px-4">
                      <DropdownMenu>
                        ...
                        <DropdownMenuContent className="bg-gray-800 border-gray-700">
                          <DropdownMenuItem className="text-white hover:bg-gray-700">Edit Role</DropdownMenuItem>
                          <DropdownMenuItem className="text-white hover:bg-gray-700">Manage Access</DropdownMenuItem>
                          <DropdownMenuItem className="text-white hover:bg-gray-700">Reset Password</DropdownMenuItem>
                          <DropdownMenuItem className="text-white hover:bg-gray-700">Resend Invite</DropdownMenuItem>
                          <DropdownMenuItem className="text-red-400 hover:bg-gray-700">Remove User</DropdownMenuItem>
                        </DropdownMenuContent>
                      </DropdownMenu>
                    </td>
                  </tr>
